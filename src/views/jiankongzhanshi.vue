  ...
  <div id="jiankongzhanshi">
    <div class="bg-color-black">
      ...
      <div class="flatPage">
        ...
        <!-- <el-button circle class="circle2"></el-button>
        <el-button circle class="circle3"></el-button> -->
...
export default {
  ...
  methods: {
    // 监控按钮点击事件
    monitorButtonClick() {
      var displayStatus = $('.monitor').css('display')
      if (displayStatus !== 'block') {
        $('.flatPage').css('display', 'none')
    ...
    // 平面页按钮点击事件
    flatPageButtonClick() {
      var displayStatus = $('.flatPage').css('display')
      if (displayStatus !== 'block') {
        $('.monitor').css('display', 'none')
        $('.flatPage').css('display', 'block')
      }
      console.log(displayStatus)
    },
  },
